        ...
        Form {
            Section(content: {
                LabeledContent("Appearance:", content: {
                    HStack(spacing: 12) {
                        AppearanceButton(title: NSLocalizedString("Light", comment: ""), isSelected: appearance == .light, icon: Appearance.light.iconName) {
                            appearance = .light
                        }
                        AppearanceButton(title: NSLocalizedString("Dark", comment: ""), isSelected: appearance == .dark, icon: Appearance.dark.iconName) {
                            appearance = .dark
                        }
                        AppearanceButton(title: NSLocalizedString("Auto", comment: ""), isSelected: appearance == .auto, icon: Appearance.auto.iconName) {
                            appearance = .auto
                        }
                    }
